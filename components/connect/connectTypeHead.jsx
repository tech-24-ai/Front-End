...
class ConnectTypeHead extends React.PureComponent {
    constructor(props) {
        super(props);
        this.state = {
            tooltipOpen: false,
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <div className="consulting-dec-btn" style={{position: "relative", top: "60px"}}>
                    <h5 className="sub-title">
                        How would you like us to help you? <span style={{ color: "#075aee",
                        fontSize: "16px",
                        fontWeight: "500",
                        lineHeight: "32px",
                        letterSpacing: "-1px",
                        marginLeft: "10px"
                        }}> {contactTypeName} </span>
...
export default ConnectTypeHead;
