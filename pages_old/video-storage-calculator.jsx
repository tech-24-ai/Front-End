...
const videoStorageCalculator = ({showError}) => {
  ...
  const result = (((averageFrameSize * FPS * NC * 60 * 60 * 24 * NoD) / 1000000 / 24) * Hrs);
      ...
      <div>
        ...
        <div className="compressionType">
          ...
          <div className="compressionDiv">
            ...
            />
            <label
              className={compressionTypeValue == "MJPEG" ? "active" : "boxText"}
              for="MJPEG"
            >
              MJPEG
            </label>
           ...
           <input
            ...
            />
            <label
              className={compressionTypeValue == "H.264" ? "active" : "boxText"}
              for="H.264"
            >
              H.264
            </label>
            ...
            />
            <label
              className={compressionTypeValue == "H.265" ? "active" : "boxText"}
              for="H.265"
            >
              H.265
            </label>
        ...
        <div className="result">
          ...
          <div className="resultText">
            {result < 1 ? (<span>{(result * 1000).toFixed(2)} MB</span>) : result >= 1000 ? (<span>{(result / 1000).toFixed(2)} TB</span>) : (<span>{result.toFixed(2)} GB</span>)}
          </div>
        </div>
      </div>
...
export default withRouter(connect(null, actionCreators)(videoStorageCalculator));
