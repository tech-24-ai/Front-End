    ...
    <div className="bandwidthCalculatorContainer">
      ...
      <div className="flexContainer">
        <div>
          ...
          <p className="leftFlexBox deduplicationText">Data deduplication ratio</p>
        </div>
        <div>
      ...
      <div className="resultSection">
        <Button onClick={calculate} className="bandwidthCalculateBtn">
          Calculate
        </Button>
      </div>
      <h5 className="result">{`Required Network Bandwidth : ${result === "NaN" ? "0" : result} Mbps`}</h5>
