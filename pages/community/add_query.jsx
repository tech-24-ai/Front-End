          ...
          <div data-grid="col-12" className="threadlist-filter-options">
            <div id="filterByTypeControls ">
              <fieldset className="c-radio f-inline">
                <h3
                  className="c-subheading-5 mt-3 "
                  id="filterByTypeLabel"
                  style={{ font: "800" }}
                >
                  Add New Query{" "}
                </h3>
              ...
              <form onSubmit={handleSubmit}>
                <div className="input-group ">
                  <Input
                    ...
                    title="Add Query"
                    className="ml-2 searchCommunity form-control"
                  />
                  ...
                  >
                    {options.map((option) => (
                      <option key={option} value={formData.tags}>
                        {option}
                      </option>
                    ))}
                  </select>
                ...
                <div className="col-md-12">
                  ...
                  <button
                    name="button"
                    className="mt-2 ml-4 round-button btn btn-primary btn-sm"
                    type="submit"
                    fdprocessedid="vwz0lf"
                  >
                    Save
                  </button>
                  <button
