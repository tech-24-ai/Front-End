...
const Profile = ({
    ...
    useEffect(() => {
        ...
        if (id) {
            crudService._getAll(`community/details/windows`).then((data) => {
                        ...
                        >
                            <div className="cards-header">
                                <Image
                                    ...
                                    height={56}
                                    preview="false"
                                    src={communityData?.data?.image_url || 'https://tech24-uat.s3.amazonaws.com/D10dkiDJHM'}
                                    alt="profile"
                                />
                            ...
                            <div className="following-section">
                                <div>
                                    ...
                                    <div className="count">{communityData?.data?.__meta__.total_members}</div>
                                </div>
                                <div className="custom-border"></div>
                                <div>
                                    <div className="head">Questions</div>
                                    <div className="count">{communityData?.data?.__meta__.total_posts}</div>
                                </div>
                            </div>
                            <hr />
                            <div
